...
export const metadata: Metadata = {
  title: '2024s elite iptv apps for android stream seamlessly with these top picks - Global Pro IPTV',
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-primary-500 mb-6">
            2024s elite iptv apps for android stream seamlessly with these top picks - Global Pro IPTV
          </h1>
